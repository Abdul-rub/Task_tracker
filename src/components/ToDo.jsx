    ...
    max-w-lg" ref={drag}>
            ...
            sm:justify-evenly">
                <div className="sm:w-1/4 text-xl font-semibold py-4">
                    ...
                    <span className="text-sm">{("0" + (time / 10)).slice(-2)}</span>
                </div>
                <div className=" flex flex-row justify-evenly
        gap-4
        ">
                    {running ? (
                        <button className="border rounder-lg py-1 px-3"
                            onClick={handleStop}>
                            Stop
                        </button>) :
                        <button className="border rounder-lg py-1 px-3"
        ...
        py-1.5 px-3 rounded-lg mt-6 mb-1" onClick={handleDelete}>Delete</button>
            </div>
        </div>
    )
}
